...
export function applyAudit(draft,result,mode){
 ...
 const normalized=validateReport({...draft,summary:summarizeVerifiedIssues(issues,mode),issues},mode);
