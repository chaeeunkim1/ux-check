...
export async function captureSite(value){
 const url=normalizeSiteUrl(value),requestBudget=createCaptureRequestBudget();let proxy,browser;const started=Date.now();let blocked=0,requestCount=0,limitBlocked=0,mainNavigationBlocked=0,lastProtocol='',stage='public_dns';
 try{
