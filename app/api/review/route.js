...
export async function POST(request) {
  ...
  try{
    ...
    return reply({report:{...report,id:randomUUID(),mode:input.mode,purpose:input.purpose,...(input.siteContext?{siteContext:input.siteContext}:{}),createdAt:new Date().toISOString(),durationMs:Date.now()-started}});
